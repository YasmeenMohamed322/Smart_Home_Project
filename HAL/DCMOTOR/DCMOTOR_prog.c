...
ES_t DCMOTOR_enuInit(void)
{
	...
	Local_enuErrorStates = DIO_enuSetPinValue(DC_IN1_PORT,DC_IN1_PIN,DIO_u8LOW);
	Local_enuErrorStates = DIO_enuSetPinValue(DC_IN2_PORT,DC_IN2_PIN,DIO_u8LOW);
...
ES_t DCMOTOR_enuChangeDirection(u8 Copy_u8Direction)
{
	...
	Local_enuErrorStates = DIO_enuSetPinValue(DC_IN1_PORT,DC_IN1_PIN,DIO_u8LOW);
	Local_enuErrorStates = DIO_enuSetPinValue(DC_IN2_PORT,DC_IN2_PIN,DIO_u8HIGH);
#elif Copy_u8Direction == ROTATE_ANTI_CLKWISE
	Local_enuErrorStates = DIO_enuSetPinValue(DC_IN1_PORT,DC_IN1_PIN,DIO_u8HIGH);
	Local_enuErrorStates = DIO_enuSetPinValue(DC_IN2_PORT,DC_IN2_PIN,DIO_u8LOW);
#else
